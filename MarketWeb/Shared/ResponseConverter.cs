...
{
    class ResponseConverter : JsonConverter
    {
        static Type GetValueType(Type objectType)
        {
            return objectType
                .BaseTypesAndSelf()
                .Where(t => t.IsGenericType && t.GetGenericTypeDefinition() == typeof(Response<>))
        ...
        const string ValuePropertyName = nameof(Response<object>.Value);
