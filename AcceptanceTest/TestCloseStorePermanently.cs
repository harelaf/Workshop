...
namespace AcceptanceTest
{
    ...
    public class TestCloseStorePermanently
    {
        ...
        public void happy_CloseStorePermanentlySuccess()
        {
            ...
            Assert.IsFalse(response.ErrorOccured, "false1 " + response.ErrorMessage);
            ...
            Assert.IsFalse(response2.ErrorOccured, "false2 " + response2.ErrorMessage);
